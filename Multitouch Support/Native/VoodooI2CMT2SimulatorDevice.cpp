...
bool VoodooI2CMT2SimulatorDevice::start(IOService* provider) {
    ...
    // Checkif force touch enabled
    uint32_t val = 0;
    if(PE_parse_boot_argn("-btnforceclick", &val, sizeof(val))){
        BUTTON_FORCE_TOUCH = true;
    }
